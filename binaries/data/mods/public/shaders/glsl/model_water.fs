...
float specularStrength = 1.5;	// Scaling for specular reflection (specular color is (this,this,this))
float waviness = 0.5;			// "Wildness" of the reflections and refractions; choose based on texture
